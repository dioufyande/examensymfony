...
use Examen_ExamenBundle\Entity\Utilisateur;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('Examen_ExamenBundle:Utilisateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Examen_ExamenBundle\Form\UtilisateurType', $utilisateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('Examen_ExamenBundle\Form\UtilisateurType', $utilisateur);
